...
export const StockViewComponent = ({ barMap, findMany }: StockViewProps) => {
    ...
    return (
        <div>
            ...
            <CandleStickChartComponent bars={barMap.get("AAPL") ?? []} variant='dark' maxWidth={800} maxHeight={400} margin={{ top: 0, right: 40, bottom: 40, left: 40 }}></CandleStickChartComponent>
        </div>
    );
}
